...
set :repo_url, 'git@github.com:Alex6Alex/api-exchanger.git'
set :application, 'api-exchanger'
application = 'api-exchanger'
set :rvm_custom_path, '/usr/share/rvm'
set :rvm_ruby_version, '2.5.1'
set :deploy_to, '/var/www/apps/api-exchanger'
  ...
  task :foreman_init do
    on roles(:all) do
      ...
      within current_path do
        ...
        execute :bundle, "exec foreman export upstart #{foreman_temp} -a #{application} -u deploy -l /var/www/apps/#{application}/log -d #{current_path}"
      end
